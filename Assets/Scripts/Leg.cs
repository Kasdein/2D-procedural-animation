...
public class Leg : MonoBehaviour
{
    ...
    private float tipAnimationTime = 0.8f;
    private float tipAnimationFrameTime = 1 / 60.0f;

    private float ikOffset = 1.0f; //height offset
    private float tipMoveDist = 0.5f; //sets the distance that the tip is allowed to move to
    private float maxRayDist = 7.0f; //sets the distance that the rays will move to find the new position of the legs
    private float tipPassOver = 0.5f / 2.0f; // not sure?
